workspace "Zápisy Workspace" "Tento Workspace dokumentuje architekturu softwarového systému Zápisy" {
    ...
    model {
        ...
        enrollments = softwareSystem "Zápisy" {
            ...
            routing_reliability = container "Spolehlivost směrovače" "Zajišťuje spolehlivost Směrovače stránek"{
                tags "quality container"
                routing_health_checker = component "Health checker" "Kontroluje stav směrovače"{
                    tags "quality component"
                }
                routing_failover = component "Failover" "Spravuje instance směrovače"{
                    tags "quality component"
                }
            }
        ...
        # QUALITY
        enrollments.routing_reliability.routing_health_checker -> enrollments.routing_reliability.routing_failover "Upozorňuje na nezdravé instance"{
                    tags "quality"
                }
        enrollments.routing_reliability.routing_health_checker -> enrollments.router.routing_engine "Kontroluje zdraví pingováním"{
                    tags "quality"
                }
    ...
    views {
        ...
        component enrollments.routing_reliability "routingReliabilityComponentView" {
            include *
        }
